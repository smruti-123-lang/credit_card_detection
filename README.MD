...
1. Clone the repo
   ```sh
   git clone https://github.com/smruti-123-lang/credit_card_detection
...
<!-- CONTACT -->
### Contact
Your Name - smrutishreemisra@gmail.com

Project Link: https://github.com/smruti-123-lang/credit_card_detection
